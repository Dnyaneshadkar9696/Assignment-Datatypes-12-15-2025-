...
public class Employee {
	public static void main(String[] args) {
		...
		System.out.println("6) Experience - " + experience + " years");
		...
		System.out.println("6) Experience - " + experience1 + " years");
		System.out.println("7) Core - " + core1);
